...
module.exports = async (req, res) => {
  ...
  try {
    ...
    let celler = 'Llista de vins actualitzada:\n';
    ...
    if (data.choices && data.choices[0]) {
      ...
      const errorMsg = data.error?.message || "Error desconegut de Groq";
      res.status(200).json({ resposta: "Problema amb la IA: " + errorMsg });
    }
