...
// Dades de la clau que m'has passat
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    let celler = 'Vins: ';
    snapshot.forEach(doc => { celler += `${doc.data().nom}, `; });
    ...
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'Ets el sommelier d\'en Pere. Respon en català sobre aquests vins: ' + celler },
